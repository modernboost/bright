...
function cr() {
  if (Oe) return A;
  Oe = 1;
  var R = Ce, y = Symbol.for("react.element"), j = Symbol.for("react.fragment"), E = Object.prototype.hasOwnProperty, W = R.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, $ = { key: !0, ref: !0, __self: !0, __source: !0 };
  function x(_, c, S) {
    var p, h = {}, m = null, Y = null;
    S !== void 0 && (m = "" + S), c.key !== void 0 && (m = "" + c.key), c.ref !== void 0 && (Y = c.ref);
    for (p in c) E.call(c, p) && !$.hasOwnProperty(p) && (h[p] = c[p]);
    if (_ && _.defaultProps) for (p in c = _.defaultProps, c) h[p] === void 0 && (h[p] = c[p]);
    return { $$typeof: y, type: _, key: m, ref: Y, props: h, _owner: W.current };
  }
...
function dr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    var R = Ce, y = Symbol.for("react.element"), j = Symbol.for("react.portal"), E = Symbol.for("react.fragment"), W = Symbol.for("react.strict_mode"), $ = Symbol.for("react.profiler"), x = Symbol.for("react.provider"), _ = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), S = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), Y = Symbol.for("react.offscreen"), Q = Symbol.iterator, Pe = "@@iterator";
    function je(e) {
    ...
    function We(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === E || e === $ || Ie || e === W || e === S || e === p || Ae || e === Y || ke || De || Fe || typeof e == "object" && e !== null && (e.$$typeof === m || e.$$typeof === h || e.$$typeof === x || e.$$typeof === _ || e.$$typeof === c || // This needs to include all possible module reference object
    ...
    function Re(e, r) {
      {
        ...
        Ee[t] = !0;
        var n = "";
        e && e._owner && e._owner !== G.current && (n = " It was passed a child from " + b(e._owner.type) + "."), w(e), l('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), w(null);
      }
    }
    function _e(e, r) {
      {
...
function pr({
  ...
  return /* @__PURE__ */ we.jsx("button", { onClick: (E) => y(E), ...j, children: R });
}
function gr({ children: R, ...y }) {
  return /* @__PURE__ */ we.jsx("div", { ...y, className: "card rounded-xl border " + y.className, children: R });
}
export {
  pr as Button,
  gr as Card
